...
<style scoped>
  .modos-de-jogo {
    background-image: linear-gradient(to top, transparent, rgb(0, 0, 37));
    display: flex;
    align-items: center;
